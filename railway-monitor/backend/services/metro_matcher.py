...
METRO_VIENNA_MAP = {
    ...
    "U4": [
        "Heiligenstadt", "Spittelau", "Friedensbrücke", "Roßauer Lände", 
        "Schottenring", "Schwedenplatz", "Landstraße", "Stadtpark", "Karlsplatz", 
        "Kettenbrückengasse", "Pilgramgasse", "Margaretengürtel", "Längenfeldgasse", 
        "Meidling Hauptstraße", "Schönbrunn", "Hietzing", "Braunschweiggasse", 
        "Unter St. Veit", "Hütteldorf"
    ],
    "U6": [
        "Floridsdorf", "Neue Donau", "Handelskai", "Dresdner Straße", "Jägerstraße", 
        "Spittelau", "Nußdorfer Straße", "Währinger Straße", "Michelbeuern", 
        "Alser Straße", "Josefstädter Straße", "Thaliastraße", "Burggasse", 
        "Westbahnhof", "Gumpendorfer Straße", "Längenfeldgasse", "Niederhofstraße", 
        "Philadelphiabrücke", "Tscherttegasse", "Am Schöpfwerk", "Alterlaa", 
...
COLORS_VIENNA = {
    ...
    "U3": "#F58220", # Naranja
    "U4": "#00A54F", # Verde
    "U6": "#9D512D"  # Marrón (Agregado para completar el mapa)
}
