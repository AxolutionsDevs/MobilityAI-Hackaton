...
export const translations: Record<City, Translations> = {
    cdmx: {
        ...
        recommendation2: '• Aumentar frecuencia de trenes en Línea 1 durante mañana',
        ...
        dragSVGFile: 'Arrastra un archivo SVG o haz clic',
        ...
        tip: '💡 Tip:',
        tipText: 'Funciona con cualquier sistema de transporte de cualquier ciudad del mundo.',
        ...
        // Footer
        footer: 'Dashboard PHI v3.0 • Análisis Predictivo • Comparación Internacional • NLP en tiempo real',
    },
    ...
    vienna: {
        ...
        dragSVGFile: 'SVG-Datei hierher ziehen oder klicken',
        ...
        // Footer
        footer: 'PHI Dashboard v3.0 • Prädiktive Analyse • Internationaler Vergleich • Echtzeit-NLP',
    },
};
